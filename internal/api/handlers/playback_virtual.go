...
func (h *PlaybackHandler) startVirtualPlaybackV3(r *http.Request, req playback.StartRequestV3, requestDigest string, file *models.MediaFile, streamURL string) (playback.DecisionResponseV3, *transportErrorV3) {
	...
	plan := playback.PlanV3{
		ProtocolVersion: playback.ProtocolV3, PlanID: planID, SessionID: session.ID,
		ExpiresAt: playback.NewPlanExpiryV3(time.Now()), Delivery: playback.DeliveryOriginalHTTPV3,
		Engine: playback.EngineMedia3DirectV3, DecisionReason: "virtual_playback_resolver",
		...
		Transformations: []playback.TransformationV3{}, AppliedQuirks: []playback.AppliedQuirkV3{}, RuntimeCorrections: []string{}, DegradationWarnings: []playback.DegradationWarningV3{},
	}
